...
@st.cache_data
def load_data():
    csv_path = os.path.join(base_dir, 'Painel_Matricula_Ed_Especial_03072025.csv')
...
bars = ax.barh(top_municipios.index, top_municipios.values, color=sns.color_palette("husl"))
...
deficiencias = filtered_df['deficiencia'].str.split(',', expand=True).stack().str.strip()
